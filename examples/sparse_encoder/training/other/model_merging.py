...
Both inputs must share the same architecture and tokenizer - typically the case
when merging fine-tunes of the same base sparse encoder. Model merging is a
built-in feature with no external dependencies.
"""
