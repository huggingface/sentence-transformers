...
``XLMRobertaForSequenceClassification``) and tokenizer - typically the case when
merging fine-tunes of the same base reranker. Model merging is a built-in feature
