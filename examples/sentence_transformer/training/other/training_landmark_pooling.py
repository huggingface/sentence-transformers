...
base_model_name = "microsoft/mpnet-base"
...
model = SentenceTransformer(
    ...
    model_card_data=SentenceTransformerModelCardData(
        language="en",
        license="apache-2.0",
        model_name=f"{base_model_name} with Landmark Pooling trained on GooAQ pairs using CachedMultipleNegativesRankingLoss",
    ),
)
...
run_name = f"{short_model_name}-gooaq-cmnrl-1024bs-lmk"
