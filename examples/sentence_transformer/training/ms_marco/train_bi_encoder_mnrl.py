...
With a distilbert/distilbert-base-uncased model, it should achieve a performance of about 33.79 MRR@10 on the MSMARCO Passages Dev-Corpus
...
class MSMARCODataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        return {"anchor": query_text, "positive": pos_text, "negative": neg_text}
