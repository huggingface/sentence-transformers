...
```{eval-rst}
.. autoclass:: sentence_transformers.sentence_transformer.model.SentenceTransformer
   :members:
...
```{eval-rst}
.. autoclass:: sentence_transformers.sentence_transformer.model_card.SentenceTransformerModelCardData
```
