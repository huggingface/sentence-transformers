...
```{eval-rst}
.. autoclass:: sentence_transformers.sentence_transformer.models.Transformer
...
```{eval-rst}
.. autoclass:: sentence_transformers.sentence_transformer.models.Module
...
.. autoclass:: sentence_transformers.sentence_transformer.models.InputModule
