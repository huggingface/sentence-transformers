...
.. note::
   ...
   If a Sentence Transformer instance ends with a :class:`~sentence_transformers.sentence_transformer.modules.Normalize` module, then it is sensible to choose the "dot" metric instead of "cosine".
