...
.. note::
   ...
   Sentence Transformers v5.2 recently released, introducing multi-processing for CrossEncoder, multilingual NanoBEIR evaluators, similarity score outputs in :class:`~sentence_transformers.util.mine_hard_negatives`, Transformers v5 support, and more. Read the `v5.2 <https://github.com/huggingface/sentence-transformers/releases/tag/v5.2.0>`_, `v5.2.1 <https://github.com/huggingface/sentence-transformers/releases/tag/v5.2.1>`_, `v5.2.2 <https://github.com/huggingface/sentence-transformers/releases/tag/v5.2.2>`_ and `v5.2.3 <https://github.com/huggingface/sentence-transformers/releases/tag/v5.2.3>`_ Release Notes for more information.
