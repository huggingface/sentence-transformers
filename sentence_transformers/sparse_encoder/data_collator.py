...
class SparseEncoderDataCollator(BaseDataCollator):
    """Collator for a SparseEncoder model that supports prompts and Router routes.
    ...
    # SparseEncoder-specific data collator parameters for mapping columns to Router routes and supporting prompts
